...
const endValue = 45000;
const doctorEndValue = 50; // Change this to your desired end value for doctors
...
Bridging Gaps, Building Healthier Communities
          </h2>
          <p className="text-descritpion">
          At the core of our vision is a commitment to transforming healthcare accessibility 
          for underserved communities globally. We envision a future where every individual, 
          regardless of socio-economic factors, has seamless access to essential healthcare services.
          </p>
          <button
    ...
    <p>Receive Patients</p>
            ...
            <div className="text-stats-container">
            <p class="count" id="doctor-count">0+</p>
    <p>Expert Doctors</p>
            </div>

            <div className="text-stats-container">
            <p class="count" id="experience-count">0+</p>
...
function startCountAnimation(target, endValue, duration) {
  ...
  function updateCount(timestamp) {
    ...
    const currentValue = Math.floor(startValue + percentage * (endValue - startValue));
